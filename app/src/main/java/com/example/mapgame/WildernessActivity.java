...
public class WildernessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        leaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(WildernessActivity.this, NavigationActivity.class));
            }
        });
    ...
    private Area buyAction(int i)
    {
        ...
        if (item.getClass().getSimpleName().equals("Equipment")) {
            ...
            if(newMass < MAXMASS)
            {
                ...
                items.remove(i);
                Toast.makeText(WildernessActivity.this, "Pickup successful", Toast.LENGTH_SHORT).show();
            }
            else
            {
                Toast.makeText(WildernessActivity.this, "To heavy to carry. Pickup Failed", Toast.LENGTH_SHORT).show();
            }
        }
        else
        {
    ...
    private void sellAction(int i)
    {
        ...
        if(areaItems.size()<9)
        {
            ...
            Toast.makeText(WildernessActivity.this, "Drop successful", Toast.LENGTH_SHORT).show();
        }
        else
        {
            Toast.makeText(WildernessActivity.this, "Wilderness Full, Drop Failed", Toast.LENGTH_SHORT).show();
        }
    }
